...
public class StructoLexer extends Lexer {
    ...
    public final void mT13() throws RecognitionException {
        try {
            int _type = T13;
            // Structo.g:12:5: ( 'write' )
            // Structo.g:12:7: 'write'
            {
            match("write"); 
    ...
    public final void mT17() throws RecognitionException {
        try {
            int _type = T17;
            // Structo.g:16:5: ( 'while' )
            // Structo.g:16:7: 'while'
            {
            match("while"); 
    ...
    public final void mID() throws RecognitionException {
        try {
            int _type = ID;
            // Structo.g:47:6: ( ( 'a' .. 'z' | 'A' .. 'Z' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' )* )
            // Structo.g:47:10: ( 'a' .. 'z' | 'A' .. 'Z' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' )*
            {
